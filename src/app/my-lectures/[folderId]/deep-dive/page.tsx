    ...
    return (
        <div className="container mx-auto py-8 max-w-4xl px-4 min-h-screen">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold font-headline">Deep Dive Wizard</h1>
                    <p className="text-sm text-muted-foreground">Words: {words.join(', ')}</p>
                </div>
                <div className="w-1/3">
            ...
            {loading && (
                <div className="flex flex-col items-center justify-center py-20 animate-pulse">
                    ...
                    <p>Preparing Level {stage === 'intro' ? '1' : stage === 'podcast' ? '2' : stage === 'collocation' ? '3' : '4'}...</p>
                </div>
            )}
                    ...
                    {stage === 'intro' && (
                        <Card className="text-center py-12">
                            <CardContent className="flex flex-col items-center">
                                ...
                                <h2 className="text-3xl font-bold mb-4">Start Deep Learning</h2>
                                <p className="text-lg text-muted-foreground mb-8 max-w-lg">
                                    We selected 5 words. You will master them through 4 stages: Context, Connections, Nuance, and Action.
                                </p>
                    ...
                    {stage === 'podcast' && podcastData && (
                        <div className="space-y-6 animate-in slide-in-from-right duration-500">
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg flex items-center gap-4 border border-blue-100">
                                ...
                                <h3 className="font-bold text-lg">Context: Listen first. Guess the meanings.</h3>
                            </div>
                            <PodcastPlayer data={podcastData} />
                            <div className="flex justify-end pt-4">
                                <Button onClick={() => nextStage('collocation')} size="lg" className="gap-2">
                                    Next: Connections <ArrowRight className="h-4 w-4" />
                                </Button>
                            </div>
                        </div>
                    )}
                    ...
                    {stage === 'collocation' && collocationData && (
                        <div className="space-y-6 animate-in slide-in-from-right duration-500">
                            <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg flex items-center gap-4 border border-indigo-100">
                                ...
                                <h3 className="font-bold text-lg">Connections: Find the pairs.</h3>
                            </div>
                            ...
                            <div className="flex justify-end pt-8">
                                <Button onClick={() => nextStage('synonym')} size="lg" className="gap-2">
                                    Next: Nuance <ArrowRight className="h-4 w-4" />
                                </Button>
                            </div>
                        </div>
                    )}
                    ...
                    {stage === 'synonym' && synonymData && (
                        <div className="space-y-6 animate-in slide-in-from-right duration-500">
                            <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg flex items-center gap-4 border border-orange-100">
                                ...
                                <h3 className="font-bold text-lg">Nuance: Upgrade your style.</h3>
                            </div>
                            <SynonymGame items={synonymData.items} />
                            <div className="flex justify-end pt-8">
                                <Button onClick={() => nextStage('interview')} size="lg" className="gap-2">
                                    Next: Activation <ArrowRight className="h-4 w-4" />
                                </Button>
                            </div>
                        </div>
                    )}
                    ...
                    {stage === 'interview' && interviewData && (
                        <div className="space-y-6 animate-in slide-in-from-right duration-500">
                            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg flex items-center gap-4 border border-purple-100">
                                ...
                                <h3 className="font-bold text-lg">Activation: Survive the interview.</h3>
                            </div>
                            <RoleplayInterface
                            ...
                            <div className="flex justify-end pt-8">
                                <Button onClick={() => nextStage('done')} size="lg" className="gap-2" variant="default">
                                    Finish Deep Dive <CheckCircle2 className="h-4 w-4" />
                                </Button>
                            </div>
                        </div>
                    )}
                    ...
                    {stage === 'done' && (
                        <Card className="text-center py-12 animate-in zoom-in duration-500">
                            <CardContent className="flex flex-col items-center">
                                ...
                                <h2 className="text-4xl font-bold mb-4 text-green-700">Mission Complete!</h2>
                                <p className="text-xl text-muted-foreground mb-8">
                                    You have deeply processed these 5 words. They are now part of your active vocabulary.
                                </p>
